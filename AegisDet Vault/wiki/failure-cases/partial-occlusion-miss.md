...
## Purpose
Define and investigate a concrete failure involving the project concern named “Partial Occlusion Miss” and its measurable effect on the AegisDet research question.
...
## Retrieval terms
aegisdet, edge-ai, miss, occlusion, partial.

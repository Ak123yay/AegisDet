...
## Purpose
Define and investigate a concrete failure involving a reproducible prediction error tied to a model, config, dataset version, and fix hypothesis.
...
## Retrieval terms
aegisdet, domain, edge-ai, failure, shift.

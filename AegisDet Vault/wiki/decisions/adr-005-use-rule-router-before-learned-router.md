---
title: "ADR 005 Use Rule Router Before Learned Router"
...
# ADR 005 Use Rule Router Before Learned Router

## Purpose
Preserve the rationale and consequences of the decision: ADR 005 Use Rule Router Before Learned Router.

## Project specification
**Context:** The decision layer that controls whether optional computation is worth its latency affects research validity, implementation cost, or deployment.
...
## Retrieval terms
005, adr, aegisdet, before, edge-ai, learned, router, rule, use.

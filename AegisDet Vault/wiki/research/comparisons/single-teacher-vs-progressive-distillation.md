---
title: "Single teacher vs progressive distillation"
...
# Single teacher vs progressive distillation

## Purpose
Compare Single teacher vs progressive distillation without confounding unrelated model, data, or runtime changes.
...
## Retrieval terms
aegisdet, distillation, edge-ai, progressive, single, teacher.

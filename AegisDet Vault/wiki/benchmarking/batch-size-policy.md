...
## Purpose
Define a reproducible benchmark for the project concern named “Batch Size Policy” and its measurable effect on the AegisDet research question.
...
## Retrieval terms
aegisdet, batch, edge-ai, policy, size.

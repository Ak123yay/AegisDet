...
## Purpose
Define a reproducible benchmark for the project concern named “Same Backend Rule” and its measurable effect on the AegisDet research question.
...
## Retrieval terms
aegisdet, backend, edge-ai, rule, same.

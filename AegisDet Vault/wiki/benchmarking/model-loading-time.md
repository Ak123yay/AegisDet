...
## Purpose
Define a reproducible benchmark for the project concern named “Model Loading Time” and its measurable effect on the AegisDet research question.
...
## Retrieval terms
aegisdet, edge-ai, loading, model, time.

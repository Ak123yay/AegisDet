...
## Purpose
Define the deployment requirements for the project concern named “Intel CPU or iGPU” and its measurable effect on the AegisDet research question.
...
## Retrieval terms
aegisdet, cpu, edge-ai, igpu, intel.

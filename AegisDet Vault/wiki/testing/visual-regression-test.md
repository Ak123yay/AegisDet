...
## Purpose
Define a deterministic test for the project concern named “Visual Regression Test” and its measurable effect on the AegisDet research question.
...
## Retrieval terms
aegisdet, edge-ai, regression, test, visual.

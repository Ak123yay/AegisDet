...
# Wildlife Dataset Card

## Purpose
Define the policy or workflow for the licensed, versioned wildlife image/label collection with leakage-resistant splits.
...
## Retrieval terms
aegisdet, card, dataset, edge-ai, wildlife.

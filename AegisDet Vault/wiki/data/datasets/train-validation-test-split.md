...
## Purpose
Define the policy or workflow for the project concern named “Train Validation Test Split” and its measurable effect on the AegisDet research question.
...
## Retrieval terms
aegisdet, edge-ai, split, test, train, validation.

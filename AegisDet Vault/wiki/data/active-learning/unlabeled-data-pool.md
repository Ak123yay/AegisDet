...
## Purpose
Define the policy or workflow for the annotation policy controlling boxes, ambiguity, occlusion, and ignore regions.
...
## Retrieval terms
aegisdet, data, edge-ai, pool, unlabeled.

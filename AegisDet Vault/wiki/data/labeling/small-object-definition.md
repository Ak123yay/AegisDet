...
## Purpose
Define the policy or workflow for the locked subset where object box area is below 1.5% of the frame.
...
## Retrieval terms
aegisdet, definition, edge-ai, object, small.

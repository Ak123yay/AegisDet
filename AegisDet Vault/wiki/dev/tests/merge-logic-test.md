...
## Purpose
Define a deterministic test for class-aware duplicate suppression after full-frame and crop inference.
...
## Retrieval terms
aegisdet, edge-ai, logic, merge, test.

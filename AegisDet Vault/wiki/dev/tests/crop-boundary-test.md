...
## Purpose
Define a deterministic test for the bounded crop-refinement path that gives small or uncertain regions more effective pixels.
...
## Retrieval terms
aegisdet, boundary, crop, edge-ai, test.

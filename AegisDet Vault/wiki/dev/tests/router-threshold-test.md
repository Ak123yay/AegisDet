...
# Router Threshold Test

## Purpose
Define a deterministic test for the decision layer that controls whether optional computation is worth its latency.
...
## Retrieval terms
aegisdet, edge-ai, router, test, threshold.

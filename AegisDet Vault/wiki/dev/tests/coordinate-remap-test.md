...
# Coordinate Remap Test

## Purpose
Define a deterministic test for the exact coordinate transform from crop-local to full-image boxes.
...
## Retrieval terms
aegisdet, coordinate, edge-ai, remap, test.

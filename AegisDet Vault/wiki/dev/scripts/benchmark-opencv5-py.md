...
# benchmark_opencv5.py

## Purpose
Specify the command-line contract and outputs for `benchmark_opencv5.py`.
...
## Retrieval terms
aegisdet, benchmark, edge-ai, opencv5.

---
title: "distill-progressive.yaml"
...
# distill-progressive.yaml

## Purpose
Define every parameter required by the configuration `distill-progressive.yaml`.
...
## Retrieval terms
aegisdet, distill, edge-ai, progressive, yaml.

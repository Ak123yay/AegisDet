...
# benchmark-opencv5.yaml

## Purpose
Define every parameter required by the configuration `benchmark-opencv5.yaml`.
...
## Retrieval terms
aegisdet, benchmark, edge-ai, opencv5, yaml.

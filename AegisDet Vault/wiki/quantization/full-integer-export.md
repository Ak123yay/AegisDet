...
## Purpose
Define the quantization behavior for the project concern named “Full Integer Export” and its measurable effect on the AegisDet research question.
...
## Retrieval terms
aegisdet, edge-ai, export, full, integer.

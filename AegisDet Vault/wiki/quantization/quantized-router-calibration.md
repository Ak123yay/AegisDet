---
title: "Quantized Router Calibration"
...
# Quantized Router Calibration

## Purpose
Define the quantization behavior for the decision layer that controls whether optional computation is worth its latency.
...
## Retrieval terms
aegisdet, calibration, edge-ai, quantized, router.

...
## Purpose
Define the quantization behavior for the project concern named “Mixed Precision” and its measurable effect on the AegisDet research question.
...
## Retrieval terms
aegisdet, edge-ai, mixed, precision.

...
## Purpose
Specify the responsibility and boundaries of the CNN-first local feature extractor producing P3/P4/P5 maps.
...
## Retrieval terms
aegisdet, backbone, cnn, edge-ai, first.

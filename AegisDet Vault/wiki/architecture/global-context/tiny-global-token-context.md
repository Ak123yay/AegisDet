---
title: "Tiny Global Token Context"
...
# Tiny Global Token Context

## Purpose
Specify the responsibility and boundaries of the deep low-resolution context mechanism that adds scene-level information.
...
## Retrieval terms
aegisdet, context, edge-ai, global, tiny, token.

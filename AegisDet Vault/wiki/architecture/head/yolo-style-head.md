...
## Purpose
Specify the responsibility and boundaries of the frozen YOLO26n control and its supported training/export interface.
...
## Retrieval terms
aegisdet, edge-ai, head, style, yolo.

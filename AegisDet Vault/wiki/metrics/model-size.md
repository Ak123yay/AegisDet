...
## Purpose
Define Model Size so every experiment calculates it consistently.

## Project specification
Report checkpoint, ONNX, engine, and quantized artifact sizes separately. Store raw per-image or per-run values whenever possible; a rounded summary alone is insufficient for audit.

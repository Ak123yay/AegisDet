...
## Purpose
Define Calibration so every experiment calculates it consistently.

## Project specification
Measure how confidence or route score corresponds to correctness using a locked validation protocol. Store raw per-image or per-run values whenever possible; a rounded summary alone is insufficient for audit.

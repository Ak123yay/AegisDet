...
## Purpose
Define False Negative Rate so every experiment calculates it consistently.

## Project specification
Count missed ground-truth objects under the frozen confidence/evaluation policy. Store raw per-image or per-run values whenever possible; a rounded summary alone is insufficient for audit.
...
## Retrieval terms
aegisdet, edge-ai, false, negative, rate.

...
## Purpose
Define p90 Latency so every experiment calculates it consistently.

## Project specification
90th-percentile warm latency; required for adaptive hard-frame cost. Store raw per-image or per-run values whenever possible; a rounded summary alone is insufficient for audit.

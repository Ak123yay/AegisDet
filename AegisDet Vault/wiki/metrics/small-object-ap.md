...
## Purpose
Define Small Object AP so every experiment calculates it consistently.

## Project specification
Evaluate only on the frozen small-object subset defined in DOMAIN_LOCK. Store raw per-image or per-run values whenever possible; a rounded summary alone is insufficient for audit.

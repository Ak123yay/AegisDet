...
## Purpose
Define Video Stability so every experiment calculates it consistently.

## Project specification
Report flicker, missed-frame gaps, persistent false alerts, and tracking overhead separately. Store raw per-image or per-run values whenever possible; a rounded summary alone is insufficient for audit.
...
## Retrieval terms
aegisdet, edge-ai, stability, video.
